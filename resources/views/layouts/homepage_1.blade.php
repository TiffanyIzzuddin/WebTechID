        ...
        <div class="col-12">
          <nav class="main-nav">
            ...
            <ul class="nav">
              ...
              <li class="scroll-to-section"><a href="#about">Portfolio</a></li>
          ...
          <div class="row">
            <div class="col-lg-6 align-self-center">
              <div class="left-content show-up header-text wow fadeInLeft" data-wow-duration="1s" data-wow-delay="1s">
                <div class="row">
                  <div class="col-lg-12">
                    <h6>Web Technology Indonesia</h6>
                    <h2>Provide Latest Info Web Tech Development</h2>
                    <p>staying updated with the latest advancements in web technology is crucial. At WebTechID Today, we bring you the most current and relevant information about web technology and development.</p>
                  </div>
                  <div class="col-lg-12">
            ...
            <div class="col-lg-6 align-self-center  wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">
              <div class="about-right-content">
                <div class="section-heading">
                  ...
                  <h4>Who is WebTechID<em>Agency</em></h4>
                  <div class="line-dec"></div>
                </div>
                <p>At WebTechID Today, we bring you the most current and relevant information about web technology and development. Our goal is to keep you informed about the trends and innovations that are shaping the future of the web.</p>
                <div class="col-lg-12">
                  <div class="border-first-button scroll-to-section">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-6 show-up wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.3s">
          <div class="blog-post">
            <div class="thumb">
              <a href="#"><img src="{{ asset('images/portfolio-01.jpg') }}" alt=""></a>
            </div>
            <div class="down-content">
              ...
              <span class="author"><img src="{{ asset('images/author-post.jpg') }}" alt="">By: Andrea Mentuzi</span>
          ...
          <div class="blog-posts">
            <div class="row">
              <div class="col-lg-12">
                <div class="post-item">
                  <div class="thumb">
                    <a href="#"><img src="{{ asset('images/blog-post-02.jpg') }}" alt=""></a>
                  </div>
              ...
              <div class="col-lg-12">
                <div class="post-item">
                  <div class="thumb">
                    <a href="#"><img src="{{ asset('images/blog-post-03.jpg') }}" alt=""></a>
                  </div>
                  <div class="right-content">
                    <span class="category">SEO Analysis</span>
                    <span class="date">24 September 2021</span>
              ...
              <div class="col-lg-12">
                <div class="post-item last-post-item">
                  <div class="thumb">
                    <a href="#"><img src="{{ asset('images/blog-post-04.jpg') }}" alt=""></a>
                  </div>
                  <div class="right-content">
                    <span class="category">SEO Analysis</span>
                    <span class="date">24 September 2021</span>
